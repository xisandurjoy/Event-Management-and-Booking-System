...
username: root
password: root
Update the username/password to match your environment. The schema is created automatically by Hibernate (ddl-auto=update). You may also run src/main/resources/db/schema.sql manually.
